...
namespace ns0
{
	internal sealed class Class22
	{
		...
		{
			GClass4.smethod_0(Class8.smethod_1("emu_loadroles"));
			this.method_10();
			DataTable dataTable = class6_0.method_3("SELECT * FROM ranks ORDER BY id ASC;");
			if (dataTable != null)
			{
			...
			dataTable = class6_0.method_3("SELECT * FROM permissions_users ORDER BY userid ASC;");
			if (dataTable != null)
			{
				foreach (DataRow dataRow in dataTable.Rows)
				{
					...
					if (Phoenix.smethod_3(dataRow["cmd_dance"].ToString()))
                    {
                        list.Add("cmd_dance");
                    }
                    if (Phoenix.smethod_3(dataRow["cmd_rave"].ToString()))
                    {
                        list.Add("cmd_rave");
                    }
                    if (Phoenix.smethod_3(dataRow["cmd_roll"].ToString()))
                    {
                        list.Add("cmd_roll");
                    }
                    if (Phoenix.smethod_3(dataRow["cmd_control"].ToString()))
                    {
                        list.Add("cmd_control");
                    }
                    if (Phoenix.smethod_3(dataRow["cmd_makesay"].ToString()))
                    {
                        list.Add("cmd_makesay");
                    }
                    if (Phoenix.smethod_3(dataRow["cmd_sitdown"].ToString()))
                    {
                        list.Add("cmd_sitdown");
                    }
					if (Phoenix.smethod_3(dataRow["cmd_exe"].ToString()))
                    {
                        list.Add("cmd_exe");
                    }
                    if (Phoenix.smethod_3(dataRow["cmd_rank"].ToString()))
                    {
                        list.Add("cmd_rank");
                    }
                    if (Phoenix.smethod_3(dataRow["cmd_summonall"].ToString()))
                    {
                        list.Add("cmd_summonall");
                    }
                    if (Phoenix.smethod_3(dataRow["cmd_sayall"].ToString()))
                    {
                        list.Add("cmd_sayall");
                    }
                    if (Phoenix.smethod_3(dataRow["cmd_enableall"].ToString()))
                    {
                        list.Add("cmd_enableall");
                    }
                    if (Phoenix.smethod_3(dataRow["cmd_freezeall"].ToString()))
                    {
			...
			dataTable = class6_0.method_3("SELECT * FROM permissions_ranks ORDER BY rank ASC;");
			if (dataTable != null)
			{
				foreach (DataRow dataRow in dataTable.Rows)
				{
			...
			dataTable = class6_0.method_3("SELECT * FROM permissions_vip;");
			if (dataTable != null)
			{
			...
			this.dictionary_5.Add(Class8.smethod_1("pet_cmd_sleep"), 1);
			this.dictionary_5.Add(Class8.smethod_1("pet_cmd_free"), 2);
			this.dictionary_5.Add(Class8.smethod_1("pet_cmd_sit"), 3);
			this.dictionary_5.Add(Class8.smethod_1("pet_cmd_lay"), 4);
			this.dictionary_5.Add(Class8.smethod_1("pet_cmd_stay"), 5);
			this.dictionary_5.Add(Class8.smethod_1("pet_cmd_here"), 6);
			this.dictionary_5.Add(Class8.smethod_1("pet_cmd_dead"), 7);
			this.dictionary_5.Add(Class8.smethod_1("pet_cmd_beg"), 8);
			this.dictionary_5.Add(Class8.smethod_1("pet_cmd_jump"), 9);
			this.dictionary_5.Add(Class8.smethod_1("pet_cmd_stfu"), 10);
			this.dictionary_5.Add(Class8.smethod_1("pet_cmd_talk"), 11);
			this.dictionary_4.Clear();
			this.dictionary_4.Add(Class8.smethod_1("cmd_about_name"), 1);
			this.dictionary_4.Add(Class8.smethod_1("cmd_alert_name"), 2);
			this.dictionary_4.Add(Class8.smethod_1("cmd_award_name"), 3);
			this.dictionary_4.Add(Class8.smethod_1("cmd_ban_name"), 4);
			this.dictionary_4.Add(Class8.smethod_1("cmd_buy_name"), 5);
			this.dictionary_4.Add(Class8.smethod_1("cmd_coins_name"), 6);
			this.dictionary_4.Add(Class8.smethod_1("cmd_coords_name"), 7);
			this.dictionary_4.Add(Class8.smethod_1("cmd_disablediagonal_name"), 8);
			this.dictionary_4.Add(Class8.smethod_1("cmd_emptyitems_name"), 9);
			this.dictionary_4.Add(Class8.smethod_1("cmd_empty_name"), 10);
			this.dictionary_4.Add(Class8.smethod_1("cmd_enable_name"), 11);
			this.dictionary_4.Add(Class8.smethod_1("cmd_flagme_name"), 12);
			this.dictionary_4.Add(Class8.smethod_1("cmd_follow_name"), 13);
			this.dictionary_4.Add(Class8.smethod_1("cmd_freeze_name"), 14);
			this.dictionary_4.Add(Class8.smethod_1("cmd_givebadge_name"), 15);
			this.dictionary_4.Add(Class8.smethod_1("cmd_globalcredits_name"), 16);
			this.dictionary_4.Add(Class8.smethod_1("cmd_globalpixels_name"), 17);
			this.dictionary_4.Add(Class8.smethod_1("cmd_globalpoints_name"), 18);
			this.dictionary_4.Add(Class8.smethod_1("cmd_hal_name"), 19);
			this.dictionary_4.Add(Class8.smethod_1("cmd_ha_name"), 20);
			this.dictionary_4.Add(Class8.smethod_1("cmd_invisible_name"), 21);
			this.dictionary_4.Add(Class8.smethod_1("cmd_ipban_name"), 22);
			this.dictionary_4.Add(Class8.smethod_1("cmd_kick_name"), 23);
			this.dictionary_4.Add(Class8.smethod_1("cmd_massbadge_name"), 24);
			this.dictionary_4.Add(Class8.smethod_1("cmd_masscredits_name"), 25);
			this.dictionary_4.Add(Class8.smethod_1("cmd_masspixels_name"), 26);
			this.dictionary_4.Add(Class8.smethod_1("cmd_masspoints_name"), 27);
			this.dictionary_4.Add(Class8.smethod_1("cmd_mimic_name"), 28);
			this.dictionary_4.Add(Class8.smethod_1("cmd_moonwalk_name"), 29);
			this.dictionary_4.Add(Class8.smethod_1("cmd_motd_name"), 30);
			this.dictionary_4.Add(Class8.smethod_1("cmd_mute_name"), 31);
			this.dictionary_4.Add(Class8.smethod_1("cmd_override_name"), 32);
			this.dictionary_4.Add(Class8.smethod_1("cmd_pickall_name"), 33);
			this.dictionary_4.Add(Class8.smethod_1("cmd_pixels_name"), 34);
			this.dictionary_4.Add(Class8.smethod_1("cmd_points_name"), 35);
			this.dictionary_4.Add(Class8.smethod_1("cmd_pull_name"), 36);
			this.dictionary_4.Add(Class8.smethod_1("cmd_push_name"), 37);
			this.dictionary_4.Add(Class8.smethod_1("cmd_redeemcreds_name"), 38);
			this.dictionary_4.Add(Class8.smethod_1("cmd_removebadge_name"), 39);
			this.dictionary_4.Add(Class8.smethod_1("cmd_ride_name"), 40);
			this.dictionary_4.Add(Class8.smethod_1("cmd_roomalert_name"), 41);
			this.dictionary_4.Add(Class8.smethod_1("cmd_roombadge_name"), 42);
			this.dictionary_4.Add(Class8.smethod_1("cmd_roomkick_name"), 43);
			this.dictionary_4.Add(Class8.smethod_1("cmd_roommute_name"), 44);
			this.dictionary_4.Add(Class8.smethod_1("cmd_sa_name"), 45);
			this.dictionary_4.Add(Class8.smethod_1("cmd_setmax_name"), 46);
			this.dictionary_4.Add(Class8.smethod_1("cmd_setspeed_name"), 47);
			this.dictionary_4.Add(Class8.smethod_1("cmd_shutdown_name"), 48);
			this.dictionary_4.Add(Class8.smethod_1("cmd_spull_name"), 49);
			this.dictionary_4.Add(Class8.smethod_1("cmd_summon_name"), 50);
			this.dictionary_4.Add(Class8.smethod_1("cmd_superban_name"), 51);
			this.dictionary_4.Add(Class8.smethod_1("cmd_teleport_name"), 52);
			this.dictionary_4.Add(Class8.smethod_1("cmd_unload_name"), 53);
			this.dictionary_4.Add(Class8.smethod_1("cmd_unmute_name"), 54);
			this.dictionary_4.Add(Class8.smethod_1("cmd_update_achievements_name"), 55);
			this.dictionary_4.Add(Class8.smethod_1("cmd_update_bans_name"), 56);
			this.dictionary_4.Add(Class8.smethod_1("cmd_update_bots_name"), 57);
			this.dictionary_4.Add(Class8.smethod_1("cmd_update_catalogue_name"), 58);
			this.dictionary_4.Add(Class8.smethod_1("cmd_update_filter_name"), 59);
			this.dictionary_4.Add(Class8.smethod_1("cmd_update_items_name"), 60);
			this.dictionary_4.Add(Class8.smethod_1("cmd_update_navigator_name"), 61);
			this.dictionary_4.Add(Class8.smethod_1("cmd_update_permissions_name"), 62);
			this.dictionary_4.Add(Class8.smethod_1("cmd_update_settings_name"), 63);
			this.dictionary_4.Add(Class8.smethod_1("cmd_userinfo_name"), 64);
			this.dictionary_4.Add(Class8.smethod_1("cmd_update_texts_name"), 65);
			this.dictionary_4.Add(Class8.smethod_1("cmd_disconnect_name"), 66);
			this.dictionary_4.Add(Class8.smethod_1("cmd_commands_name"), 67);
			this.dictionary_4.Add("about", 68);
			this.dictionary_4.Add(Class8.smethod_1("cmd_roominfo_name"), 69);
			this.dictionary_4.Add(Class8.smethod_1("cmd_dance_name"), 71);
			this.dictionary_4.Add(Class8.smethod_1("cmd_rave_name"), 72);
			this.dictionary_4.Add(Class8.smethod_1("cmd_roll_name"), 73);
			this.dictionary_4.Add(Class8.smethod_1("cmd_control_name"), 74);
			this.dictionary_4.Add(Class8.smethod_1("cmd_makesay_name"), 75);
			this.dictionary_4.Add(Class8.smethod_1("cmd_sitdown_name"), 76);
            this.dictionary_4.Add(Class8.smethod_1("cmd_exe_name"), 77);
			...
			this.dictionary_4.Add(Class8.smethod_1("cmd_emptypets_name"), 83);
            this.dictionary_4.Add("rank", 84);
            this.dictionary_4.Add("summonall", 85);
            this.dictionary_4.Add("sayall", 86);
			...
			try
			{
				...
				{
					GClass4.smethod_1("Commands loaded:" + this.dictionary_4.Count.ToString());
				}
			}
			catch
			{
		...
		public bool method_11(string string_0, Class16 class16_0)
		{
			bool result;
			switch (string_0)
			{
			...
			case "roomusersmte":
			case "roomuserslte":
				if (class16_0.method_2().method_3("wired_cnd_roomusers"))
				{
					result = true;
					return result;
				}
			...
			case "userhasntachievement":
				if (class16_0.method_2().method_3("wired_cnd_userhasachievement"))
				{
					result = true;
					return result;
				}
			...
			case "userhasbadge":
			case "userhasntbadge":
				if (class16_0.method_2().method_3("wired_cnd_userhasbadge"))
				{
					result = true;
					return result;
				}
			...
			case "userhasvip":
			case "userhasntvip":
				if (class16_0.method_2().method_3("wired_cnd_userhasvip"))
				{
					result = true;
					return result;
				}
			...
			case "userhasnteffect":
				if (class16_0.method_2().method_3("wired_cnd_userhaseffect"))
				{
					result = true;
					return result;
				}
			...
			case "userranklt":
			case "userranklte":
				if (class16_0.method_2().method_3("wired_cnd_userrank"))
				{
					result = true;
					return result;
				}
			...
			case "usercreditslt":
			case "usercreditslte":
				if (class16_0.method_2().method_3("wired_cnd_usercredits"))
				{
					result = true;
					return result;
				}
			...
			case "userpixelslt":
			case "userpixelslte":
				if (class16_0.method_2().method_3("wired_cnd_userpixels"))
				{
					result = true;
					return result;
				}
			...
			case "userpointslt":
			case "userpointslte":
				if (class16_0.method_2().method_3("wired_cnd_userpoints"))
				{
					result = true;
					return result;
				}
			...
			case "usergroupeq":
			case "userisingroup":
				if (class16_0.method_2().method_3("wired_cnd_usergroups"))
				{
					result = true;
					return result;
				}
			...
			case "wearing":
			case "notwearing":
				if (class16_0.method_2().method_3("wired_cnd_wearing"))
				{
					result = true;
					return result;
				}
			...
			case "carrying":
			case "notcarrying":
				if (class16_0.method_2().method_3("wired_cnd_carrying"))
				{
					result = true;
					return result;
				}
		...
		public bool method_12(string string_0, Class16 class16_0)
		{
			bool result;
			switch (string_0)
			{
			case "sql":
				if (class16_0.method_2().method_3("wired_give_sql"))
				{
					result = true;
					return result;
				}
				break;
			case "badge":
				if (class16_0.method_2().method_3("wired_give_badge"))
				{
					result = true;
					return result;
				}
				break;
			case "effect":
				if (class16_0.method_2().method_3("wired_give_effect"))
				{
					result = true;
					return result;
				}
				break;
			case "award":
				if (class16_0.method_2().method_3("wired_give_award"))
				{
					result = true;
					return result;
				}
				break;
			case "dance":
				if (class16_0.method_2().method_3("wired_give_dance"))
				{
					result = true;
					return result;
				}
				break;
			case "send":
				if (class16_0.method_2().method_3("wired_give_send"))
				{
					result = true;
					return result;
				}
				break;
			case "credits":
				if (class16_0.method_2().method_3("wired_give_credits"))
				{
					result = true;
					return result;
				}
				break;
			case "pixels":
				if (class16_0.method_2().method_3("wired_give_pixels"))
				{
					result = true;
					return result;
				}
				break;
			case "points":
				if (class16_0.method_2().method_3("wired_give_points"))
				{
					result = true;
					return result;
				}
				break;
			case "rank":
				if (class16_0.method_2().method_3("wired_give_rank"))
				{
					result = true;
					return result;
				}
				break;
			case "respect":
				if (class16_0.method_2().method_3("wired_give_respect"))
				{
					result = true;
					return result;
				}
				break;
			case "handitem":
				if (class16_0.method_2().method_3("wired_give_handitem"))
				{
					result = true;
					return result;
				}
				break;
			case "alert":
				if (class16_0.method_2().method_3("wired_give_alert"))
				{
					result = true;
					return result;
				}
