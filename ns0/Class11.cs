...
namespace ns0
{
	internal sealed class Class11
	{
		...
		{
            uint uint_9 = this.uint_0;
			bool result;
            if (class16_0.method_2().bool_69)
            {
                uint_9 = (uint)Phoenix.smethod_15().method_4().method_9();
                result = true;
            }
			if (Phoenix.smethod_15().method_4().method_3(uint_9))
			{
				result = Phoenix.smethod_15().method_4().method_4(uint_9, string_7);
			}
			else
			{
