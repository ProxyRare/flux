...
namespace ns0
{
    internal sealed class Phoenix
    {
        ...
        public const string string_1 = "http://localhost/phx/";
        ...
        public string string_3 = "http://localhost/phx/licence" + Convert.ToChar(46).ToString() + "php" + Convert.ToChar(63).ToString();
        public static string string_4 = "http://localhost/phx/override" + Convert.ToChar(46).ToString() + "php";
        ...
        public void method_0()
        {
            ...
            if (!Class66.smethod_0(true))
            {
                ...
                try
                {
                    ...
                    Phoenix.string_6 = new Random().Next(Int32.MaxValue).ToString();
